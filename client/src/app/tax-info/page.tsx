...
export default function TaxInfoPage() {
  return <SimplePage title="Tax Information" description="For current donation and tax documentation details, please contact the foundation directly." href="/contact" label="Contact the foundation" />;
}

function SimplePage({ title, description, href, label }: { title: string; description: string; href: string; label: string }) {
  return (
